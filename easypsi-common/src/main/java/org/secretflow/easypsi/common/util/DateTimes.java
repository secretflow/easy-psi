...
public class DateTimes {
    ...
    public static final DateTimeFormatter LOCAL_DATE_TIME_FORMATTER2 = DateTimeFormatter.ofPattern("yyyy-MM-dd-HH-mm-ss");
    ...
    /**
     * Convert localDateTime to formatter string
     *
     * @param ldt
     * @return String
     */
    public static String localDateTimeString(LocalDateTime ldt, DateTimeFormatter formatter) {
