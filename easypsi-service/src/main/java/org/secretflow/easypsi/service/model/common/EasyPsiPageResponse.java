...
@Data
@AllArgsConstructor
public class EasyPsiPageResponse<E> implements Serializable {
    ...
    public static <T> EasyPsiPageResponse<T> toPage(Page<T> page) {
        return new EasyPsiPageResponse<>(page.getContent(), page.getTotalElements());
    }

    public static <T> EasyPsiPageResponse<T> toPage(List<T> content, long totalElements) {
