...
public interface ProjectService {
     ...
     */
    EasyPsiPageResponse<ProjectJobListVO> listProjectJob(ListProjectJobRequest projectId);
    ...
    List<ProjectJobListByBlackScreenVO> listProjectJobByBlackScreen(ListProjectJobRequest request);
